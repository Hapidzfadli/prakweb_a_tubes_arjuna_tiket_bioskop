...
<div class="card-statistic p-4">
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="row">
                <div class="col-8">
                    <h2 class="number-stats">500.000</h2>
                    <div class="name-stats">Saldo</div>
                </div>
                <div class="col-4 icon-stats">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="/img/woman.png" alt="" style="width: 45px; height: 45px;" class="rounded-circle">
                                <div class="ms-3">
                ...
                <tbody>
                    {{-- @foreach ($users->take(6) as $user) --}}
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="https://web3.21cineplex.com/movie-images/22CIRS.jpg" alt="" style="width: 45px; height: 45px;" class="rounded-circle">
                                    <div class="ms-3">
                                        <p class="fw-bold mb-1">CIRKUS</p>
                                        <p class="text-muted mb-0">#tyu-987</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
